namespace HRFinalProjectTest.Web.Core.Consts
{
    public static class Errors
    {
        ...
        public const string NotAllowedExtension = "Only .pdf, .docx, .csv files are allowed!";
        ...
        public const string specifictitle = "You Must Enter the specific Job Title.";
        public const string mobilenumber = "You Must Enter the mobile number right.";
    }
}